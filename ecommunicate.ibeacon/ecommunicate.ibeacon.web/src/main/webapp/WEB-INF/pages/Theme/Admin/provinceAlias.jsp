...
<div class="container" style="position: relative;">
	...
	<div id="main">
		...
		<h3 style="position: relative; left: 35%; top: 75%">
			<i class="fa fa-envelope-square"></i>&nbsp; Manage ProvinceAlias
		</h3>
							...
							<table
								...
								<tbody>
									<tr class="gradeA"
										...
										<td>{{$index+1}}</td>
										<td>
											<div ng-hide="editingData[area.id]">{{area.alias |
												uppercase}}</div>
											<div ng-show="editingData[area.id]">
												<input type="text" ng-model="area.alias" />
											</div>
										</td>
										<td>
											<div ng-hide="editingData[area.id]">{{area.province |
												uppercase}}</div>
											<div ng-show="editingData[area.id]">
												<input type="text" ng-model="area.province" />
											</div>
										</td>
...
<span1 id="span1" style="color:red ;display:none"></span1>
										<input type="text" ng-model="choice.alias" name=""
											id="choice.id" class="form-control" placeholder="Alias Name"
										...
										<div style="border: 2px ridge rgb(63, 138, 176);">
<span1 id="span1" style="color:red ;display:none"></span1>
										<input type="text" ng-model="choice.province" name=""
											id="choice.id" class="form-control" placeholder="Province Name"
											style="width: 80%;position:relative;left:9%;margin:6px 0px 0px 0px">
...
<script
	src="${pageContext.request.contextPath}/assets/js/CustomJs/provinceAlias.js"></script>
<script
