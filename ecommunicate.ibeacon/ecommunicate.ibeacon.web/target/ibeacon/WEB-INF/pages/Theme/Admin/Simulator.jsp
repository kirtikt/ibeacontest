...
<label><b>Short code message</b></label>
									<div class="iconic-input">

										<textarea class="form-control" placeholder="Province , Suburb"
										 ng-model="input.province"
											ng-trim="false">Short code message</textarea>
										<span3 ng-bind="span3" style="color:red;">
										<b></b></span0>
									</div>
								
									<!-- <label><b>Enter Suburb</b></label>
									<div class="iconic-input">

										<textarea class="form-control" placeholder="Enter Message"
										 ng-model="input.areaCode"
											ng-trim="false">Short code message</textarea>
										<span0 ng-bind="span0" style="color:red;">
										<b></b></span0>
									</div>
								</div> -->
								<div class="form-group">
								...
								<div class="form-group">
									<div class="col-lg-offset-2 col-lg-10">
										...
										<button class="btn btn-primary" data-toggle="modal"
											data-target=".bs-example-modal-sm">Send SMS</button>

	<button class="btn btn-primary" ng-click="getOutput()">Get Output On Screen</button>
													...
													<div class="modal-content">
														<div class="modal-header">
															...
															<button type="button" class="btn btn-primary"
																ng-click="sendRequest()" data-dismiss="modal">Select</button>
															<button type="button" class="btn btn-primary"
...
<script
	src="${pageContext.request.contextPath}/assets/js/CustomJs/simulator.js"></script>
