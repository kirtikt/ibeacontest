						...
						<div class="col-lg-12">
							<section class="panel">
								<header class="panel-heading"
									...
									<b>Showing Subscription Reports for {{date}} to {{date1}} </b>
								</header>
							...
							src="${pageContext.request.contextPath}/assets/img/loading.gif" />
                               ...
                               -->
										...
										<td class="center hidden-phone" ng-show="checked">{{sms.MessageCost}}</td>
													...
													<td>{{ $index+1}}</td>
													<td>{{ sms.userID}}</td>
														<td>{{subsStatus[sms.updateType]}}</td>
												<!-- 	<td >{{sms.updateType}}</td> -->
													<td>{{sms.starttime|dateFilter}}</td>
													<td>{{sms.expiryTime|dateFilter}}</td>
													<td>{{sms.cycleEndTime|dateFilter}}</td>
...
<script
	src="${pageContext.request.contextPath}/assets/js/CustomJs/viewSubscription.js"></script>